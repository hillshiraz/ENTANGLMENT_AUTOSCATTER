...
if __name__ == "__main__":
    ...
    if RUN_CASE in (1, 4):
        ...
        print(g_opt)
        viz.print_colored_matrix(g_opt)
        print("\nOptimal synthesized ν:")
        print(nu_opt)
        viz.print_colored_matrix(nu_opt)
    ...
    if RUN_CASE in (2, 4):
        ...
        #print(g_opt_2)
        viz.print_colored_matrix(g_opt_2)

        print("\n[Second example] Optimal synthesized ν:")
        #print(nu_opt_2)
        viz.print_colored_matrix(nu_opt_2)
    ...
    if RUN_CASE in (3, 4):
        ...
        viz.print_colored_matrix(g_opt_3)

        print("\n[Case 3] Optimal synthesized ν:\n", nu_opt_3)

        viz.print_colored_matrix(nu_opt_3)